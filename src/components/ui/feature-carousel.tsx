...
const steps = [
  {
    ...
    description: "Get tailored movie recommendations based on your viewing history and preferences. Our advanced AI algorithm ensures you'll always find something new to love.",
  },
  {
    id: "2",
    name: "Watch",
    title: "Immersive Viewing Experience",
    description: "Enjoy high-definition streaming with advanced audio options. Switch between different viewing modes to match your current mood and environment.",
  },
  {
    id: "3",
    name: "Connect",
    title: "Social Integration",
    description: "Share your favorite movies with friends and see what they're watching. Create watch parties and discuss films in real-time with our integrated chat feature.",
  },
  {
    id: "4",
    name: "Explore",
    title: "Vast Movie Library",
    description: "Access thousands of titles across multiple genres, from classic masterpieces to the latest blockbusters. New content added weekly to keep your watchlist fresh.",
  },
] as const
...
const ANIMATION_PRESETS = {
  fadeInScale: {
    ...
    transition: {
      type: "spring",
      stiffness: 250, // Reduced for smoother animation
      damping: 30, // Increased for less oscillation
      mass: 0.6, // Increased for more deliberate movement
    },
  },
  slideInRight: {
...
const StepImage = forwardRef<
  HTMLImageElement,
  StepImageProps & Omit<React.ComponentPropsWithoutRef<'img'>, keyof StepImageProps>
>(
  (
...
function FeatureCard({
  ...
  return (
    ...
    >
      ...
      >
        <div className="m-6 md:m-10 min-h-[500px] w-full">
          <AnimatePresence mode="wait">
            <motion.div
              key={step}
              className="flex w-full md:w-5/6 flex-col gap-4 md:gap-5"
            ...
            >
              <motion.h2
                className="text-xl md:text-3xl font-bold tracking-tight text-white font-jost"
              ...
              >
                <p className="text-sm leading-6 md:text-base md:leading-7 text-neutral-300 dark:text-zinc-300 font-jost max-w-lg">
...
function Steps({
  ...
  return (
    <nav aria-label="Progress" className="flex justify-center px-4">
      <ol
        className="flex w-full flex-wrap items-start justify-center gap-2 md:gap-4 md:w-10/12 md:divide-y-0"
        role="list"
      >
        {steps.map((step, stepIdx) => {
          ...
          return (
            ...
            >
              ...
              >
                <span className="flex items-center gap-2 text-sm font-medium font-jost">
                  <motion.span
                    initial={false}
                    animate={{
                  ...
                  <motion.span
                    ...
                    animate={{ opacity: 1, x: 0 }}
                    className={clsx(
                      "text-sm font-medium duration-300 font-jost hidden sm:block",
...
const defaultClasses = {
  step1img1:
    "pointer-events-none w-[42%] sm:w-[45%] border border-border-100/10 transition-all duration-500 dark:border-border-700/50 rounded-2xl shadow-xl",
  step1img2:
    "pointer-events-none w-[42%] sm:w-[45%] border border-border-100/10 dark:border-border-700/50 transition-all duration-500 overflow-hidden rounded-2xl shadow-xl",
  step2img1:
    "pointer-events-none w-[42%] sm:w-[45%] border border-border-100/10 transition-all duration-500 dark:border-border-700 rounded-2xl overflow-hidden shadow-xl",
  step2img2:
    "pointer-events-none w-[38%] sm:w-[40%] border border-border-100/10 dark:border-border-700 transition-all duration-500 rounded-2xl overflow-hidden shadow-xl",
  step3img:
    "pointer-events-none w-[75%] sm:w-[80%] border border-border-100/10 dark:border-border-700 rounded-2xl transition-all duration-500 overflow-hidden shadow-xl",
  step4img:
    "pointer-events-none w-[75%] sm:w-[80%] border border-border-100/10 dark:border-border-700 rounded-2xl transition-all duration-500 overflow-hidden shadow-xl",
} as const
...
export function FeatureCarousel({
  ...
  const handleAnimationComplete = () => {
    ...
    // to ensure current animations are fully complete
    setTimeout(() => {
  ...
  const renderStepContent = () => {
    const content = () => {
      switch (step) {
        case 0:
          /**
           * Layout: Two images side by side with precise positioning
           * - Left image: positioned at left 5%, top 15%
           * - Right image: positioned at right 5%, top 30%
           * Animation:
           * - Left image slides in from left
           * - Right image slides in from right with 0.4s delay
           */
          return (
            <motion.div
            ...
            >
              ...
              <AnimatedStepImage
                ...
                preset="slideInRight"
                delay={0.6}
                style={{ position: "absolute", right: "5%", top: "30%", zIndex: 2 }}
              />
            </motion.div>
          )
        case 1:
          /**
           * Layout: Two images with precise positioning
           * - First image: positioned at left 8%, top 20%
           * - Second image: positioned at right 8%, top 35%
           * Animation:
           * - Both images fade in and scale up from 95%
           * - Second image has 0.5s delay for staggered effect
           */
          return (
            <motion.div
              className="relative w-full h-full"
            ...
            >
              <AnimatedStepImage
                ...
                preset="fadeInScale"
                delay={0.2}
                style={{ position: "absolute", left: "8%", top: "20%", zIndex: 1 }}
              />
              <AnimatedStepImage
                alt={image.alt}
                ...
                preset="fadeInScale"
                delay={0.7}
                style={{ position: "absolute", right: "8%", top: "35%", zIndex: 2 }}
              />
            </motion.div>
          )
        case 2:
           ...
           * - Full width image: 80% width, centered
           * Animation:
          ...
          return (
            ...
            >
              <AnimatedStepImage
                ...
                preset="fadeInScale"
                delay={0.3}
                style={{ position: "absolute", left: "10%", top: "25%", zIndex: 1 }}
              />
            </motion.div>
          )
        case 3:
  ...
  return (
    <FeatureCard {...props} step={step}>
      ...
      <motion.div
        ...
        className="absolute left-0 top-0 z-50 w-full cursor-pointer"
      >
